...
public class TablaProcesos {
	...
	// ORDENA LA TABLA DE MENOR A MAYOR SEG�N LA COLUMNA DEL PROCESO
	...
	// VALIDA CADA SEGUNDO S� EXISTE UN PROCESO NUEVO Y S� SU TIEMPO DE CPU
	...
	public void validarProcesoNuevo(int i) {
		...
		// VALIDA S� EL PROCESO ACTUAL LLEG� A CERO
    ...
    // DESPU�S DE QUE UN PROCESO LLEGA A CERO ESTE M�TODO VALIDA
				...
				if (a[j] < y) {
					if (b[j] > 0) {
						if (b[j] < procesoCorto) {
							procesoCorto = b[j];
							this.proceso = j;
							System.out.println("Proceso m�s corto");
	...
	// TIEMPO DE EJECUCI�N + TIEMPO DE ESPERA = TIEMPO DE RESPUESTA
