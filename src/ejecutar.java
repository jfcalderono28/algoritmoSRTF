		...
		TimerTask timerTask = new TimerTask() {
			...
			public void run() {
				...
				if (tablaProcesos.getProceso() == 5) {//EL PROCESO ACTUAL NO EXISTE, 5
					...
					//SÍ NO ES 5 SIGNIFICA QUE EL PRIMER PROCESO EN LLEGAR Y CON MENOR
					...
					cond = tablaProcesos.validarProcesoNuevo(i); //VALIDA SÍ EXISTE UN NUEVO PROCESO O SÍ EL PROCESO ACTUAL LLEGO A CERO
